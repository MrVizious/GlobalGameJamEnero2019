...
public class InputVisualizer : MonoBehaviour
{
    ...
    public void AddLetter(string s){
        ...
        //if(!(letters.Count >= letterHolders.Count)){
            letters.Add(Instantiate(letterPrefab, new Vector3((float) letterHolders[letters.Count].transform.position.x + 0.15f,(float)  letterHolders[letters.Count].transform.position.y + 0.15f,(float)  letterHolders[letters.Count].transform.position.z - 0.15f), Quaternion.identity));
